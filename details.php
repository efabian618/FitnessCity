...
if ($sql->fetchColumn() > 0) {
    ...
    $sql = $con->prepare("SELECT id, nombre, descripcion, precio, descuento,stock FROM productos WHERE slug=? AND activo=1");
    $sql->execute([$slug]);
...
<head>
    ...
    <title>FitnessCity - Producto</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 order-md-2">
                    ...
                    <p class="lead">Disponibles:<?php echo $row['stock']; ?></p>
